/* 01) Implemente um programa que tenha como entrada um número (1-7) que corresponde a um dos dias
...
int main(){
    ...
    int dia;
        ...
        printf("Digite o numero correspondente ao dia da semana [1 - 7]: \n");
        scanf("%i", &dia);
